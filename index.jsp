...
<ul>
<li><a href="testpage.jsp?query=whadventureworksshipment">OLAP Adventure Works Shipment</a></li>
<li><a href="testpage.jsp?query=whadventureworks">OLAP Adventure Works Sales</a></li>
