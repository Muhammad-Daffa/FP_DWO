                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="chart5.php">Berat Pengiriman Per Tahun</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?whadventureworks" style="height:300px ;width:100%; border:none; text-align:center;">
                        </iframe>
                        <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?whadventureworksshipment" style="height:300px ;width:100%; border:none; text-align:center;">
                        </iframe>
                    </div>
                </main>
