...
<html lang="en">
    <head>
        ...
        <title>Chart Total Transaksi Per Tahun</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Chart Total Transaksi Per Tahun</h1>
                        <div class="card mb-4">
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-chart-pie me-1"></i>
                                Chart Total Transaksi Tiap Tahunnya
                            </div>
                            <?php
                                        $host       = "localhost";
                                        $user       = "root";
                                        ...
                                        $sql = "SELECT CONCAT('name:',t.year) as year, CONCAT('y:', SUM(fs.total_due)*100/" . $tot_amount[0] .") as y, CONCAT('drilldown:', t.year) as drilldown 
                                        FROM timedimens t
                                        ...
                                        $sql = "SELECT t.year year, t.month month, SUM(fs.total_due) as total
                                        FROM timedimens t
                                        JOIN fact_shipment fs ON (t.time_id = fs.time_id)
                                        GROUP BY year, month";
    ...
    // Create the barchart
            ...
            title: {
                text: 'Persentase Total Transaksi Tiap Tahun'},
                subtitle: {
