...
<html lang="en">
    <head>
        ...
        <title>Pendapatan Per Tahun</title>
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Chart Pendapatan Per Tahun</h1>
                        <div class="card mb-4">
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-chart-pie me-1"></i>
                                Chart Jumlah Pendapatan Berdasarkan Bulan dan Tahun
                            </div>
                            <?php
                                        $host       = "localhost";
                                        $user       = "root";
                                        ...
                                        $sql = "SELECT t.year year, t.month month, SUM(fs.line_total) as total
                                        FROM timedimens t
                                        JOIN fact_sales fs ON (t.time_id = fs.time_id)
                                        GROUP BY year, month";
        ...
        <script type="text/javascript">
            ...
            title: {
                text: 'Persentase Pendapatan Dari Barang Terjual Berdasarkan Tahun'},
                subtitle: {
                    text:'Klik untuk melihat detail jumlah dari setiap bulan'
                },
                accessibility: {
                    announceNewData: {
                        enabled: true
